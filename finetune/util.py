...
def F_measure(cm):
    ...
    result = {}
    result['known_f1'] = f_seen
    result['open_f1'] = f_unseen
    result['all_f1'] = f
...
def draw(x, y):
    ...
    colors = (
    'gray', 'lightgreen', 'plum', 'DarkMagenta', 'SkyBlue', 'PaleTurquoise', 'DeepPink', 'Gold', 'Orange', 'Brown',
    'DarkKhaki')
...
def plot_curve(points):
    ...
    plt.figure()
    plt.grid(alpha=0.4)
    markers = ['o', '*', 's', '^', 'x', 'd', 'D', 'H', 'v', '>', 'h', 'H', 'v', '>', 'v', '<', '>', '1', '2', '3', '4',
               'p']
